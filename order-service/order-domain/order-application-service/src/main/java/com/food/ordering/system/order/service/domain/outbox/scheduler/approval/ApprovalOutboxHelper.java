...
public class ApprovalOutboxHelper {
    ...
    public void save(OrderApprovalOutboxMessage orderApprovalOutboxMessage) {
        ...
        if (response == null) {
            ...
            throw new OrderDomainException(format("Could not save OrderApprovalOutboxMessage with outbox id: %s",
                                                  orderApprovalOutboxMessage.getId()));
        }
    ...
    private String createPayload(OrderApprovalEventPayload orderApprovalEventPayload) {
        try {
            ...
            log.error("Could not create OrderApprovalEventPayload as String for order id: {}",
                      orderApprovalEventPayload.getOrderId());
            throw new OrderDomainException(
                format("Could not create OrderApprovalEventPayload as String for order id: %s",
                       orderApprovalEventPayload.getOrderId()));
        }
    }
}
